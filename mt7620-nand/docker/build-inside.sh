...
grep -q "CONFIG_TARGET_ramips_mt7620-nand_DEVICE_xiaomi_miwifi-r3=y" .config || {
...
cp -v bin/targets/ramips/mt7620-nand/*miwifi-r3* /repo/mt7620-nand/out/
cp -v bin/targets/ramips/mt7620-nand/sha256sums /repo/mt7620-nand/out/ 2>/dev/null || true
awk '$1 == "kernel" { print "kernel package: " $3 }' bin/targets/ramips/mt7620-nand/*.manifest | head -n1
